...
BEGIN_MESSAGE_MAP(CMFC_toolboxApp, CWinApp)
...
CMFC_toolboxApp::CMFC_toolboxApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_toolboxApp 物件

CMFC_toolboxApp theApp;


// CMFC_toolboxApp 初始設定

BOOL CMFC_toolboxApp::InitInstance()
{
